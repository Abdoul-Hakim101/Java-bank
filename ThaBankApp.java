...
accs.add(new Savings("John", "56983456124557001", 5000));
accs.add(new Checking("Alice", "4663127800259845", 3990));
accs.add(new Savings("Joseph", "7880023589711036", 5000));
accs.add(new Checking("Maxx", "9003588723341633", 4500));
accs.add(new Savings("Evans", "1193008990018631", 2600));
